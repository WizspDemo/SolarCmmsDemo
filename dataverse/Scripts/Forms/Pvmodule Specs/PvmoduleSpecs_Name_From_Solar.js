// JavaScript για solar_PVModuleSpecs: ενημέρωση του name από το lookup Solar

// Λογικά ονόματα από πίνακα solar_pvmodulespecs (Solardev – από Dataverse schema)
// Lookup προς Park/Solar (solar_location) στο solar_pvmodulespecs
const FIELD_SOLAR_LOOKUP = "solar_park";
// Primary name πεδίο στο solar_pvmodulespecs
const FIELD_NAME = "solar_pvmodulespecsname";
 ...
 */
function setPvmoduleNameFromSolar(executionContext) {
 ...
 * @param {Xrm.Events.EventContext} executionContext
 */
function onLoad_SetPvmoduleNameFromSolar(executionContext) {
    setPvmoduleNameFromSolar(executionContext);
}
 ...
 */
function onSave_SetPvmoduleNameFromSolar(executionContext) {
    setPvmoduleNameFromSolar(executionContext);
}
