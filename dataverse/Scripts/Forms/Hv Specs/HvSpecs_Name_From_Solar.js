// JavaScript για solar_HVSpecs: ενημέρωση του name από το lookup Solar

// Λογικά ονόματα από πίνακα solar_hvspecs (Solardev – από Dataverse schema)
// Lookup προς Park/Solar (solar_park) στο solar_hvspecs
const FIELD_SOLAR_LOOKUP = "solar_park";
// Primary name πεδίο στο solar_hvspecs
const FIELD_NAME = "solar_hvspecsname";
 ...
 */
function setHvSpecsNameFromSolar(executionContext) {
 ...
 * @param {Xrm.Events.EventContext} executionContext
 */
function onLoad_SetHvSpecsNameFromSolar(executionContext) {
    setHvSpecsNameFromSolar(executionContext);
}
 ...
 */
function onSave_SetHvSpecsNameFromSolar(executionContext) {
    setHvSpecsNameFromSolar(executionContext);
}
