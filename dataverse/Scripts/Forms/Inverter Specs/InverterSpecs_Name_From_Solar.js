// JavaScript για solar_InverterSpecs: ενημέρωση του name από το lookup Solar

// Λογικά ονόματα από πίνακα solar_inverterspecs (Solardev – από Dataverse schema)
// Lookup προς Park/Solar (solar_location) στο solar_inverterspecs
const FIELD_SOLAR_LOOKUP = "solar_park";
// Primary name πεδίο στο solar_inverterspecs
const FIELD_NAME = "solar_inverterspecsname";
