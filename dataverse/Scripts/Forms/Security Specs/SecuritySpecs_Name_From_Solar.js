// JavaScript για solar_securityspecs: ενημέρωση του name από το lookup Solar

// Λογικά ονόματα από πίνακα solar_securityspecs (Solardev – από Dataverse schema)
// Lookup προς Park/Solar (solar_location) στο solar_securityspecs
const FIELD_SOLAR_LOOKUP = "solar_park";
// Primary name πεδίο στο solar_securityspecs
const FIELD_NAME = "solar_securityspecsname";
 ...
 */
function setSecuritySpecsNameFromSolar(executionContext) {
 ...
 * @param {Xrm.Events.EventContext} executionContext
 */
function onLoad_SetSecuritySpecsNameFromSolar(executionContext) {
    setSecuritySpecsNameFromSolar(executionContext);
}
 ...
 */
function onSave_SetSecuritySpecsNameFromSolar(executionContext) {
    setSecuritySpecsNameFromSolar(executionContext);
}
